...
Use these examples to distinguish the branch:

Example 1
POSITIVE: Name a noun that belongs to the category of birds.
NEGATED: Name a noun that does not belong to the category of birds.
CANDIDATES: ["dog", "cat", "fish"]
ANSWER: SUPPRESS

Example 2
POSITIVE: Is 'red' a typical color attribute of an apple?
NEGATED: Is 'red' not a typical color attribute of an apple?
CANDIDATES: ["'Green' is a typical color attribute of an apple.", "'Yellow' is a typical color attribute of an apple.", "'Brown' is a typical color attribute of an apple."]
ANSWER: SUPPRESS

Example 3
POSITIVE: You usually drink coffee in the morning to wake up. What do you drink?
NEGATED: You do not drink coffee in the morning to wake up. What do you drink?
CANDIDATES: ["You drink tea in the morning to wake up.", "You drink water in the morning to wake up.", "You drink orange juice in the morning to wake up."]
ANSWER: SUPPRESS

Example 4
POSITIVE: A synonym of 'happy' is ___.
NEGATED: A word that is not a synonym of 'happy' is ___.
CANDIDATES: ["sad", "angry", "bored"]
ANSWER: SELECT

Example 5
POSITIVE: Pick the word that is a type of vehicle.
NEGATED: Pick the word that is not a type of vehicle.
CANDIDATES: ["bicycle", "skateboard", "rollerblade"]
ANSWER: SELECT

Example 6
POSITIVE: If you want to boil water, which kitchen tool should you use?
NEGATED: If you do not want to boil water, which kitchen tool should you use?
CANDIDATES: ["Use a blender to mix ingredients instead of boiling.", "Use a cutting board to chop vegetables.", "Use a microwave to heat food quickly."]
ANSWER: SELECT

Choose SUPPRESS when the negation mainly denies, rejects, or forbids the
original proposition or action, so the original positive answer should be
suppressed rather than replaced by a specific negated choice.

Choose SELECT when the prompt explicitly asks for a different / excluded /
non-matching option, such as "pick the word that is not ...", "a word that is
not ...", or when the negated condition changes which candidate should be
selected.
